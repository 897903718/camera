...
public class ScreenSwitchUtils {
    ...
    // 是否是竖屏
    private boolean isPortrait = true;//默认竖屏
...
//        Log.d(TAG, init_orientation_listener.);
        // 注册重力感应器,监听屏幕旋转
...
//        Log.d(TAG, stop orientation listener.);
    ...
    public void toggleScreen() {
        ...
        if (isPortrait) {
            isPortrait = false;
            // 切换成横屏
            Toast.makeText(mContext,"切换成横屏",Toast.LENGTH_LONG).show();
            //mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            } else {
            isPortrait = true;
            // 切换成竖屏
            Toast.makeText(mContext,"切换成竖屏",Toast.LENGTH_LONG).show();
//            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            }
        }
